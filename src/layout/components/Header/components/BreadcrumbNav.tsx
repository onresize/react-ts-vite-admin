...
const BreadcrumbNav = observer((props: any) => {
	...
	newItems.unshift({ title: t({ id: "header.home" }), href: `/react-ts-vite-admin${HOME_URL}` });
	// console.log('newItems:', newItems)

	return <Fragment>{header.breadcrumb && <Breadcrumb items={newItems} {...{ style }}></Breadcrumb>}</Fragment>;
});
